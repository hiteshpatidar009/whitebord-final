      ...
      >
        ...
        >
          ...
          <div
            ...
            className='absolute right-12 bottom-6 w-8 h-8 rounded-full bg-gray-900 text-white flex items-center justify-center cursor-pointer shadow-lg hover:bg-gray-800'
            title='Rotate'
          >
            ⟳
          </div>
