...
export const PdfPreview: React.FC = () => {
  const { pdfPages, currentPdfPage, setCurrentPdfPage } = useWhiteboardStore();
  ...
  return (
    <>
      ...
      >
        {/* Close Button (Mobile Only - Optional now, but keeping for explicit close) */}
        ...
        <div className="relative p-4 border-b border-gray-200 dark:border-gray-700 mt-6 sm:mt-0">
          ...
          <button
            ...
            className="absolute top-0 -right-6 h-full bg-white dark:bg-gray-900 border-y border-r border-gray-200 dark:border-gray-700 rounded-r-lg shadow-md p-1 w-6 flex items-center justify-center text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors z-50"
