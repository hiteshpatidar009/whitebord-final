    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            className={`absolute bottom-6 left-2 text-[10px] font-bold ${colors.textColor}`}
          >
            cm
          </span>
          ...
          <div
            className={`absolute left-16 top-1/2 ${colors.angleBadge} px-3 py-1 rounded-lg text-sm font-bold shadow-lg`}
          ...
          {/* 45° at top */}
          <div
            className={`absolute left-2 top-6 text-sm font-bold ${colors.angleTextColor}`}
          >
            45°
          </div>
          {/* 90° at bottom-left corner */}
          <div
            className={`absolute left-0 bottom-0 w-6 h-6 border-t-[3px] border-r-[3px] ${colors.squareCorner}`}
          />
          <div
            className={`absolute left-10 bottom-10 text-lg font-bold ${colors.angleTextColor}`}
          >
            90°
          </div>
          {/* 45° at bottom-right */}
          <div
            className={`absolute right-6 bottom-2 text-sm font-bold ${colors.angleTextColor}`}
          >
            45°
          </div>
          ...
          <button
            ...
            className={`absolute left-6 top-14 w-7 h-7 rounded-full ${colors.closeBtn} flex items-center justify-center`}
          >
            ×
          </button>

          {/* Theme Toggle Button - Now positioned just next to degree viewer */}
          <button
            onClick={toggleTheme}
            className={`absolute left-32 top-1/2 w-7 h-7 rounded-full 
